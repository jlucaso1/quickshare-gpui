...
pub struct OutboundRequest {
    ...
    // Reusable encoding buffers to avoid repeated allocations in encrypt_and_send
    encode_buf: Vec<u8>,
    frame_buf: Vec<u8>,
...
impl OutboundRequest {
    pub fn new(
        ...
        Self {
            ...
            frame_buf: Vec::with_capacity(600 * 1024),
    ...
    async fn finalize_key_exchange(
        ...
        self.encrypt_key_aes = Some(client_key[..32].try_into().unwrap());
        self.decrypt_key_aes = Some(server_key[..32].try_into().unwrap());
